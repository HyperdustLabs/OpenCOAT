...
| `opencoat_runtime_llm`       | L3    | LLM and embedder clients (bai, openai, anthropic, azure, ollama, stub) |
...
pip install "opencoat-runtime[openai]"          # OpenAI SDK; also covers B.AI (OpenAI-compatible)
