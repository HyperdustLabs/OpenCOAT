...
| **EffectorKernel.run_turn** | ✅ | `opencoat_runtime_core/effector/kernel.py`, `test_effector_kernel.py` |
| **Connectome split (cold)** | ✅ | `connectome_split.py` + `PlasticityEngine.cold_step`, `test_plasticity_split.py` |
